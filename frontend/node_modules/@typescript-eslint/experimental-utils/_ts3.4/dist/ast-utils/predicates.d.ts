...
declare function isNotOptionalChainPunctuator(token: TSESTree.Token): boolean;
declare function isNonNullAssertionPunctuator(token: TSESTree.Token): token is TSESTree.PunctuatorToken & {
    value: '!';
};
declare function isNotNonNullAssertionPunctuator(token: TSESTree.Token): boolean;
/**
 ...
 */
declare function isAwaitKeyword(node: TSESTree.Token | undefined | null): node is TSESTree.KeywordToken & {
    value: 'await';
};
